<template>
    <div>
        ...
        <div class="uploadfile">
            <el-upload ref="upload" class="upload-demo" :before-upload="beforeUpload" drag :auto-upload="false"
        ...
        <!--上传完成提示对话框-->
        <el-dialog title="提示" :visible="dialogVisible" width="30%" :modal-append-to-body='false'>
            <span>文件上传成功</span>
...
export default {
    ...
    methods: {
        beforeUpload(file) {
            ...
            this.$axios.post('/upload', fd, config) ///////
                .then((res) => {
